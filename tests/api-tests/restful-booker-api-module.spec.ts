...
test("Verify that the user is able to fetch the specific booking ID using GET API and receive valid response", {tag:['@SMOKE','@HIGH LEVEL', '@REGRESSION'], annotation:{type: 'test case', description:'test description'}}, async({request})=>{
...
test("Verify that the user is able to create new booking using POST API and receive valid response", 
...
test("Verify that the user is able to update a existing booking using PUT API and receive valid response", 
    {tag:['@SMOKE','@HIGH LEVEL', '@REGRESSION'], 
        annotation:{type: 'test case', description:'test description'}
    }, async({request})=>{
